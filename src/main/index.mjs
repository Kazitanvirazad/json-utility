...
import uiHelpers from './uiInvocationhelpers.mjs'
...
app.whenReady().then(() => {
  // Registering UI helpers
  uiHelpers.forEach((helper) => {
    ipcMain.handle(helper._name, helper._function)
  })
  // Set the app name before creating the menu (important for macOS menu bar)
  if (process.platform === 'darwin') {
